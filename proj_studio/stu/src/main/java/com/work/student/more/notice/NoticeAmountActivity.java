...
import com.work.student.HomeActivity;
import com.work.student.MoreActivity;
import com.work.student.R;
import com.work.student.adapter.NoticeAmountAdapter;
import com.work.student.bean.TeaStuPat;
 ...
 * @author 左丽姬
 *  */
public class NoticeAmountActivity extends Activity implements OnClickListener {
	...
	public void getAmunt() {
		if (!IBaes.isNet(this)) {
			IBaes.toastShow(NoticeAmountActivity.this, "网络不给力,请稍后...");
			return;
		}
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				if (status == 1) {
					...
					IBaes.toastShow(NoticeAmountActivity.this, zhuce);
				}
				break;
			}
		}
