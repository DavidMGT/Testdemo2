...
import com.work.teacher.adapter.NoticeAdapter;
...
import com.work.teacher.view.CustomListView.OnLoadMoreListener;
import com.work.teacher.view.CustomListView.OnRefreshListener;
 ...
 * @author 左丽姬
 */
public class NoticeListActivity extends Activity implements OnClickListener, OnLoadingDialogResultListener {
        ...
        noticeLists.setOnLoadListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                if (harmore) {
                    ...
                    IBaes.toastShow(NoticeListActivity.this, "没有更多数据");
                }
