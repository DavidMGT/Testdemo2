...
import com.work.teacher.tool.ScreenUtil;
...
public class TimeSelector {
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(DateUtil.format(date, FORMAT_STR));
                seletorDialog.dismiss();
            }
        });
    ...
    private void loadComponent() {
        ...
        if(month<10){
        	month_pv.setSelected("0"+month);
        }else{
        	month_pv.setSelected(month+"");
        }
        if(day<10){
        	day_pv.setSelected("0"+day);
        }else{
        	day_pv.setSelected(day+"");
        }
        if(hours<10){
        	hour_pv.setSelected("0"+hours);
        }else{
        	hour_pv.setSelected(hours+"");
        }
        if(minutes<10){
        	minute_pv.setSelected("0"+minutes);
        }else{
        	minute_pv.setSelected(minutes+"");
        }
        excuteScroll();
    }
