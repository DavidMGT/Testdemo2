 ...
 * <p>鍓╀綑涓や釜Flag锛歮IsAutoLoadMore(鏄惁鑷姩鍔犺浇鏇村)锟�
...
public class CustomListView extends ListView implements OnScrollListener {
	...
	/**  鏄剧ず鏍煎紡鍖栨棩鏈熸ā锟�  */
	private final static String DATE_FORMAT_STR = "yyyy年M月d日HH:mm";
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (mCanRefresh) {
			if(mCanLoadMore && mEndState == ENDINT_LOADING){
				// 濡傛灉瀛樺湪鍔犺浇鏇村鍔熻兘锛屽苟涓斿綋鍓嶆鍦ㄥ姞杞芥洿澶氾紝榛樿涓嶅厑璁镐笅鎷夊埛鏂帮紝蹇呴』鍔犺浇瀹屾瘯鍚庢墠鑳戒娇鐢拷?
